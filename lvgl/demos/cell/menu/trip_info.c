...
static void open_window() {
  ...
  ui_helpers_create_label_left(menu_window_get(), &elements[8], 345, y_pos[1],
                               300, 48, color, LABEL_FONT_HARMONYOS_24,
                               lang_text(TEXT_ID_ODO));
  ui_helpers_create_label_left(menu_window_get(), &elements[9], 345, y_pos[2],
                               300, 48, color, LABEL_FONT_HARMONYOS_24,
                               lang_text(TEXT_ID_TRIP));

  ui_helpers_menu_image(elements, "trip_bg.png", 11, 290, 254);
  ui_helpers_menu_image(elements, "odo_speed.png", 12, 415, 273);
  ui_helpers_menu_image(elements, "odo_mileage.png", 13, 415, 313);
  ui_helpers_menu_image(elements, "odo_fule.png", 14, 601, 273);
  ui_helpers_menu_image(elements, "odo_time.png", 15, 601, 313);

  ui_helpers_create_label_left(menu_window_get(), &elements[16], 315, 263, 300,
                               48, color, LABEL_FONT_HARMONYOS_24, "TRIP 1");
  ui_helpers_create_label_left(menu_window_get(), &elements[17], 455, 263, 300,
                               48, color, LABEL_FONT_HARMONYOS_24, "42 km/h");
  ui_helpers_create_label_left(menu_window_get(), &elements[18], 455, 304, 300,
                               48, color, LABEL_FONT_HARMONYOS_24, "200 km");
  ui_helpers_create_label_left(menu_window_get(), &elements[19], 640, 263, 300,
                               48, color, LABEL_FONT_HARMONYOS_24,
                               "6.2 L/100km");
  ui_helpers_create_label_left(menu_window_get(), &elements[20], 640, 304, 300,
                               48, color, LABEL_FONT_HARMONYOS_24, "12h 35min");

  int off_set = 95;
  ui_helpers_menu_image(elements, "odo_speed.png", 21, 415, 273 + off_set);
  ui_helpers_menu_image(elements, "odo_mileage.png", 22, 415, 313 + off_set);
  ui_helpers_menu_image(elements, "odo_fule.png", 23, 601, 273 + off_set);
  ui_helpers_menu_image(elements, "odo_time.png", 24, 601, 313 + off_set);
  ui_helpers_create_label_left(menu_window_get(), &elements[25], 315,
                               263 + off_set, 300, 48, color,
                               LABEL_FONT_HARMONYOS_24, "TRIP 2");
  ui_helpers_create_label_left(menu_window_get(), &elements[26], 455,
                               263 + off_set, 300, 48, color,
                               LABEL_FONT_HARMONYOS_24, "42 km/h");
  ui_helpers_create_label_left(menu_window_get(), &elements[27], 455,
                               304 + off_set, 300, 48, color,
                               LABEL_FONT_HARMONYOS_24, "200 km");
  ui_helpers_create_label_left(menu_window_get(), &elements[28], 640,
                               263 + off_set, 300, 48, color,
                               LABEL_FONT_HARMONYOS_24, "6.2 L/100km");
  ui_helpers_create_label_left(menu_window_get(), &elements[10], 640,
                               304 + off_set, 300, 48, color,
                               LABEL_FONT_HARMONYOS_24, "12h 35min");
}
